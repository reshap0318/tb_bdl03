...
<body>
  ...
  <section id="container">
    <header class="header black-bg">
      ...
      <a class="logo">
        <p><img src="assets/ico/111.png"><b>W</b>EB<b style="font-size: 17px">GIS</b></p>
      </a>
                ...
                <ul class="sub">
                  <div class="panel-body">
                    ...
                    <select class="form-control" id="kecamatan1">
                      <?php
                                include("connect.php");
                                $kecamatan=mysqli_query($conn,"select * from district ");
                                while($rowkecamatan = mysqli_fetch_array($kecamatan))
                                {
                ...
                <ul class="sub">
                  ...
                  <div class="panel-body">
                    ...
                    <select class="form-control" style="width: 90%;" id="jurusan">
                      <?php
                                include("connect.php");
                                $angkot=mysqli_query($conn,"select * from angkot ");
 ...
 $pengunjung       = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM statistika2  WHERE tanggal='$tanggal' GROUP BY ip, hits, online, tanggal")); // Hitung jumlah pengunjung
 $totalpengunjung  = mysqli_fetch_array(mysqli_query($conn,"SELECT COUNT(hits) as tas FROM statistika2 ")); // hitung total pengunjung
 $bataswaktu       = time() - 300;
 $pengunjungonline = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM statistika2  WHERE online > '$bataswaktu'")); // hitung pengunjung online
 ?>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      var unique_id = $.gritter.add({
        ...
        text: ' <span>Today : <?php echo $pengunjung; ?> <br> Total : <?php echo $totalpengunjung['
        tas ']; ?> <br> Online User : <?php echo $pengunjungonline; ?>	</span>',
